Este projeto consiste em uma aplicação multiplataforma(web e mobile) em Angular com framework Ionic para documentação e acompanhamento de projetos de conclusão de curso.
